...
// struct Image : public ::platf::Image {
//   ~Image() override {
//     delete[] data;
//     data = nullptr;
//   }
...
// void blend_cursor_monochrome(const Cursor &cursor, Image &img) {
...
// void blend_cursor_color(const Cursor &cursor, Image &img, const bool masked) {
...
// void blend_cursor(const Cursor &cursor, Image &img) {
...
// Capture display_ram_t::capture(snapshot_cb_t &&snapshot_cb, std::shared_ptr<::platf::Image> img, bool *cursor) {
...
// Capture display_ram_t::snapshot(::platf::Image *img_base, std::chrono::milliseconds timeout, bool cursor_visible) {
//   auto img = (Image *)img_base;
...
// std::shared_ptr<platf::Image> display_ram_t::alloc_img() {
...
// int display_ram_t::dummy_img(platf::Image *img) {
//   return 0;
// }

// int display_ram_t::init(int framerate, const std::string &display_name) {
//   if(DisplayBase::init(framerate, display_name)) {
//     return -1;
//   }
